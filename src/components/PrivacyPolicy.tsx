      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 md:p-12">
        ...
        <section className="mb-8">
          <p className="text-gray-700 mb-4">
            This Privacy Policy describes how Student Sahayak and its affiliates
            collect, use, share, protect or otherwise process your information/
            personal data through our website{" "}
            <a
              href="https://www.studentsahayak.in"
          ...
          <h2 className="text-2xl font-semibold text-gray-800 mb-3">Sharing</h2>
          <p className="text-gray-700 mb-4">
