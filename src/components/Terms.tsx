      ...
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg p-8 md:p-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="font-bold">Student Shayak</span> and its affiliates
          ...
          <p className="text-gray-700 mb-4">
            ...
            and related information provided from time to time. Some of the
            ...
            email, a call from a person/association claiming to be seeking any
            personal data like debit/credit card PIN, net-banking or mobile
            banking password, we request you to never provide such information.
            If you have already revealed such information, report it immediately
            to an appropriate law enforcement agency.
          </p>

          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Usage</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Sharing</h3>
          <p className="text-gray-700 mb-4">
          ...
          <h3 className="text-2xl font-semibold text-gray-800 mb-3">Consent</h3>
          <p className="text-gray-700 mb-4">
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            ...
            <span className="font-bold">https://www.studentsahayak.in</span>{" "}
            (“Website”), including the related mobile site and mobile
            application (hereinafter referred to as “Platform”). The Platform is
            owned by <span className="font-bold">Student Sahayak</span>, a
            company incorporated under the Companies Act, 1956 with its
            registered office at{" "}
            <span className="font-bold">
              shyam lok colony, najafgarh, New Delhi - 110043
            </span>{" "}
            ...
            for provide further information. You understand that upon initiating
            a transaction for availing the Services you are entering into a
            ...
            its affiliates, group companies (as applicable) and their respective
            ...
            infringement of intellectual property rights) of a third party. In
            no event will the Platform Owner be liable for any indirect,
            ...
            Hundred (Rs. 100) whichever is less Notwithstanding anything
            ...
            the courts in <span className="font-bold">Delhi, New Delhi</span>{" "}
        ...
        <section>
          ...
          <h4 className="text-xl font-semibold text-gray-800 mb-2">Return</h4>
          <p className="text-gray-700 mb-4">
            ...
            received it will be inspected and the return will be approved within
            2 days.
          </p>

          <h4 className="text-xl font-semibold text-gray-800 mb-2">Refunds</h4>
          <p className="text-gray-700">
